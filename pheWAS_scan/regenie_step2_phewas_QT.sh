...
################################################################################
# Script: regenie_step2_phewas_QT.sh
# Author: Kiran Biddinger
# Project: mashHF
#
# Description:
#   REGENIE Step 2 for quantitative PHEWAS traits using UKBB array data.
#   Performs per-chunk rare variant association tests (ACAT-O), with optional
#   Cauchy p-value combination, across selected canonical LOF genes.
#
# Usage:
#   bash regenie_step2_phewas_QT.sh <CHR> <CHUNK> <CHUNK_TOTAL>
#
# Inputs:
#   - REGENIE step 1 predictions
#   - Variant annotations, grouping, and AAF files
#   - Canonical LOF gene list and tissues of interest
#   - mashHF phenotype file
#
# Outputs:
#   - Raw REGENIE set-based results (per trait)
#   - Cauchy-combined results (per trait)
#   - Output uploaded to DNAnexus directories
################################################################################
...
#------------------------------------------------------------------------------
# Download software and helper scripts
#------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------
# Define traits and tissues of interest
#------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------
# Define subset of genes (canonical LOF targets)
#------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------
# Filter gene sets to run for this chromosome/chunk
#------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------
# Cauchy combination of p-values for each trait
#------------------------------------------------------------------------------
